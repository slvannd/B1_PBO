package Posttest3_Darniah;

import Posttest3_Darniah.KebunBinatang;
import java.util.ArrayList;
import java.util.Scanner;

public class Manajemen_KebunBinatang {
    public static void main(String[] args){
        ArrayList<KebunBinatang> dataHewan = new ArrayList<>();
        ...
        do {
            ...
            if (pilih == 1){
                ...
                dataHewan.add(new KebunBinatang(nama, jenis, habitat, jumlah));
                ...
                dataHewan.set(no-1, new KebunBinatang(nama, jenis, habitat, jumlah));
