...
public class Jasajahit {
    ArrayList<POSTTEST2.DataPelanggan> data_pelanggan = new ArrayList<>();
    ...
    public void dataPelangganTampil(){
        ...
        for(int i=0; i < data_pelanggan.size(); i++){
            POSTTEST2.DataPelanggan data = data_pelanggan.get(i);
    ...
    public void dataPelangganTambah(){
        ...
        switch (pilihanAksi) {
            case 1:
                data_pelanggan.add(new POSTTEST2.DataPelanggan(id, nama, jenis_kelamin, alamat, nohp));
                dataPelangganTambah();
                break;
            case 2:
                data_pelanggan.add(new POSTTEST2.DataPelanggan(id, nama, jenis_kelamin, alamat, nohp));
    ...
    public void dataPelangganEdit(){
        ...
        if(ketemu==false){
            ...
            switch (pilihanAksi) {
                case 1:
                    data_pelanggan.set(index, new POSTTEST2.DataPelanggan(id_pelanggan, nama_pelanggan, jenis_kelamin, alamat_pelanggan, nohp));
                    dataPelanggan();
                    break;
                case 2:
                    dataPelangganEdit();
