 ...
 */
public class Main {
    ArrayList<Pelanggan> data_pelanggan = new ArrayList<>();
    ArrayList<Pesanan> data_pesanan = new ArrayList<>();
    ...
    public void dataPelangganTampil(){
        ...
        for(int i=0; i < data_pelanggan.size(); i++){
            Pelanggan data = data_pelanggan.get(i);
    ...
    public void dataPelangganTambah(){
        Scanner myInput = new Scanner(System.in);
        String id, nama, jenis_kelamin, alamat, nohp,jenis_jahitan,ukuran,jenis_kain,jumlah;
        int pilihanAksi;
        ...
        switch (pilihanAksi) {
            case 1:
                data_pelanggan.add(new Pelanggan(id, nama, jenis_kelamin, alamat, nohp,jenis_jahitan,ukuran,jenis_kain,jumlah));
                dataPelangganTambah();
                break;
            case 2:
                data_pelanggan.add(new Pelanggan(id, nama, jenis_kelamin, alamat, nohp,jenis_jahitan,ukuran,jenis_kain,jumlah));
    ...
    public void dataPelangganEdit(){
        ...
        if(ketemu==false){
            ...
            nohp = myInput.nextLine();
            System.out.print("Jenis Jahitan : ");
            String jenis_jahitan = myInput.nextLine();
            System.out.print("Ukuran : ");
            String ukuran = myInput.nextLine();
            System.out.print("Jenis Kain : ");
            String jenis_kain = myInput.nextLine();
            System.out.print("Jumlah : ");
            String jumlah = myInput.nextLine();
            System.out.println();
            System.out.println();
            ...
            switch (pilihanAksi) {
                case 1:
                    data_pelanggan.set(index, new Pelanggan(id_pelanggan, nama_pelanggan, jenis_kelamin, alamat_pelanggan, nohp,jenis_jahitan,ukuran,jenis_kain,jumlah));
                    dataPelanggan();
                    break;
                case 2:
                    dataPelangganEdit();
    ...
    public void tampilDataPesanan(){
        ...
        for(int i=0; i < data_pesanan.size(); i++){
            Pesanan data = data_pesanan.get(i);
            ...
            System.out.print(data.nama_pelanggan + "\t");
            System.out.println(data.jenis_kelamin + "\t");
            System.out.println(data.alamat_pelanggan + "\t");
            System.out.println(data.nohp);
            System.out.println();
        }
    ...
    public void dataPesananTambah (){
        ...
        jumlah = myInput.nextLine();
        System.out.print("Nama Pelanggan : ");
        String nama_pelanggan = myInput.nextLine();
        System.out.print("Jenis Kelamin : ");
        String jenis_kelamin = myInput.nextLine();
        System.out.print("Alamat Pelanggan : ");
        String alamat_pelanggan = myInput.nextLine();
        System.out.print("No HP : ");
        String nohp = myInput.nextLine();
        System.out.println();
        ...
        switch (pilihanAksi) {
            case 1:
                data_pesanan.add(new Pesanan(id, jenis_jahitan, ukuran, jenis_kain, jumlah, nama_pelanggan, jenis_kelamin, alamat_pelanggan, nohp));
                dataPesananTambah();
                break;
            case 2:
                data_pesanan.add(new Pesanan(id, jenis_jahitan, ukuran, jenis_kain, jumlah, nama_pelanggan, jenis_kelamin, alamat_pelanggan, nohp));
    ...
    private void dataPesananEdit (){
        ...
        if(ketemu==false){
            ...
            switch (pilihanAksi) {
                case 1:
                    data_pesanan.set(index, new Pesanan(id_pesanan, jenis_jahitan, ukuran, jenis_kain, jumlah, nama_pelanggan, jenis_kelamin, alamat_pelanggan, nohp));
                    dataPesanan();
                    break;
                case 2:
                    dataPesananEdit();
